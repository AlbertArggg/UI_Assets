namespace PropollyGDS.Scripts
{
    public partial class Constants
    {
        ...
        public class ProjectEntities
        {
            ...
            public static readonly string ANIMATION_FILE = PROJECT_ENTITIES + "AnimationFile";
            ...
            public static readonly string CS_ABSTRACT = PROJECT_ENTITIES + "CS_Abstract";
            public static readonly string CS_CLASS = PROJECT_ENTITIES + "CS_Class";
            public static readonly string CS_INTERFACE = PROJECT_ENTITIES + "CS_Interface";
            public static readonly string CS_MONO = PROJECT_ENTITIES + "CS_Mono";
            public static readonly string DEFAULT = PROJECT_ENTITIES + "Default";
            ...
            public static readonly string SHADER_FILE = PROJECT_ENTITIES + "ShaderFile";
